<%@ Page Title="" Language="VB" MasterPageFile="~/UserMaster.master" AutoEventWireup="false" CodeFile="ClientSetup.aspx.vb" Inherits="ClientSetup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <table style="width: 100%">
         ...
         <tr>
             ...
             <td style="width: 134px">Access Level:</td>
             <td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">Confirm Password:</td>
             <td style="width: 239px">
         ...
         <tr>
             ...
             <td style="width: 134px">Business Address:</td>
             <td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">Occupation:</td>
             <td style="width: 239px">
             ...
             <td style="width: 134px">Mobile No:</td>
             <td>
         ...
         <tr>
             ...
             <td style="width: 134px">Policy No:</td>
             <td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">Convey(Air) Rate:</td>
             <td style="width: 239px">
                            <asp:TextBox ID="txtAirRate" runat="server" Width="200px" >0</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtAirRate" CssClass="failureNotification" ErrorMessage="*" ToolTip="*" ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                        </td>
             <td style="width: 134px">Convey(Sea) Rate:</td>
             <td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">Motor(Comp) Rate:</td>
             <td style="width: 239px">
                            <asp:TextBox ID="txtMotrate" runat="server" Width="200px" >0</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtMotrate" CssClass="failureNotification" ErrorMessage="*" ToolTip="*" ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                        </td>
             <td style="width: 134px">&nbsp;</td>
             <td>
                            &nbsp;</td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">Exclusion:</td>
             <td style="width: 239px">
             ...
             <td style="width: 134px">Clause Type:</td>
             <td>
         ...
         <tr>
             <td style="width: 151px">&nbsp;</td>
             <td style="width: 133px">*Tax ID No:</td>
             <td style="width: 239px">
             ...
             <td style="width: 134px">Excess:</td>
             <td>
         ...
         <tr>
             ...
             <td style="width: 134px">Business Unit:</td>
             <td>
         ...
         <tr>
             ...
             <td style="width: 239px">
                            ...
                            &nbsp;</td>
             <td style="width: 134px">Show Forex value:</td>
             <td>
