...
Partial Class Signup
    ...
    Protected Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        Try
            ...
            '    Exit Sub  strSQL &= "Reg_CompNo='" & txtTIN.Text & "',"
            'End If
    ...
    End Sub
    Public Sub SendMail()
        Dim ToAddress As String = ddlunit.SelectedValue & ", COhaka@Custodianinsurance.com, EIsujeh@Custodianinsurance.com " ''
    ...
    Private Sub FillGrid2()
        Try
            ...
            StrSqlDatagrid = "select Reg_Username As UserName,Reg_Compname As Insured,Reg_Unit As Unit,Reg_mUser As Broker,Reg_Business As Business,Reg_Tel As Telephone,convert(varchar,(CONVERT(date,Reg_Date,103)),103) as Date,Reg_Account As Access from dbo.Profile_Details where Reg_Account != 'Administrator' and reg_Categ is null order by Reg_Username "
